...
//                     <span className="relative text-gray-700 hover:text-green-600 transition-colors duration-300 font-medium py-2 px-1 cursor-pointer">
//                       {item.label}
...
//                           className="px-4 py-3 hover:bg-green-50 hover:text-green-600 cursor-pointer transition-colors duration-200 first:rounded-t-md last:rounded-b-md"
//                         >
//                           {child.label}
//                         </div>
//                       ))}
...
//                       className="relative text-gray-700 hover:text-green-600 transition-colors duration-300 font-medium py-2 px-1 group cursor-pointer"
//                     >
//                       {item.label}
//                       <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-green-500 to-blue-500 group-hover:w-full transition-all duration-300"></span>
//                     </a>
...
//                 className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105"
//               >
//                 Donate Now
//               </button>
//             </div>
...
//                                   href={child.href}
//                                   onClick={(e) => handleNavClick(e, child.href)}
//                                   className="block py-2 px-8 rounded-lg text-gray-600 hover:bg-green-50 hover:text-green-600 transition-colors duration-200 text-sm"
//                                 >
//                                   {child.label}
//                                 </a>
//                               ))}
...
//                                 href={item.href}
//                                 onClick={(e) => handleNavClick(e, item.href)}
//                                 className="block py-3 px-4 rounded-lg text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors duration-200 font-medium"
//                               >
//                                 {item.label}
//                               </a>
//                             </li>
...
//                         <button
//                           onClick={(e) => handleNavClick(e, "/get-involved")}
//                           className="w-full bg-gradient-to-r from-green-500 to-blue-500 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300"
//                         >
//                           Donate Now
//                         </button>
